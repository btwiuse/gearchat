  ...
  const SidebarOption = ({ Icon, IconOnHover, caption, onClick }) => (
    <>
      <div className="sidebar__option">
        <div className="sidebar__option--noHover">
          <Icon />
        </div>
        <div className="sidebar__option--hover">
          <IconOnHover onClick={onClick} />
        </div>
    ...
    <div className="sidebar">
      ...
      <div className="sidebar__footer">
        <SidebarOption
          ...
          IconOnHover={ChatBubbleIcon}
          caption="Chats"
        />
        <SidebarOption
          Icon={PeopleOutlineIcon}
          IconOnHover={PeopleIcon}
          caption="Contacts"
        />
        <SidebarOption
          Icon={ExploreOutlinedIcon}
          IconOnHover={ExploreIcon}
          caption="Discover"
        />
        <SidebarOption
          Icon={PersonOutlineIcon}
          IconOnHover={PersonIcon}
          caption="Logout"
          onClick={signOut}
        />
      </div>
